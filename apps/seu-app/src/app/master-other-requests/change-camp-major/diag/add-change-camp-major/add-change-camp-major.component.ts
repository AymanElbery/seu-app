...
import { ChangeCampMajorMasterService } from 'src/app/master-other-requests/services/change-camp-major.service';
import { MAT_DIALOG_DATA, MatDialogRef } from '@angular/material/dialog';
import { NgForm } from '@angular/forms';
import { AppToasterService } from 'src/app/shared/services/app-toaster';

@Component({
  selector: 'app-add-change-camp-major-master',
...
export class AddChangeCampMajorComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data,
    ...
    private toastr: AppToasterService, private acadmicProc: ChangeCampMajorMasterService) { }
