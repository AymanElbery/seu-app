...
@Component({
  selector: 'app-skills-std-skills-courses',
  templateUrl: './skills-std-skills-courses.component.html',
  styleUrls: ['./skills-std-skills-courses.component.css']
})
export class SkillsStdSkillsCoursesComponent implements OnInit {
  ...
  getMyCourses() {
    this.isLoading = true;
    this.coursesService.myskillscourses().subscribe((response) => {
