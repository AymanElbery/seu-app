...
import { ManagerNewrequestsService } from '../../../../services/resume-manager-newrequest';
...
@Component({
  selector: 'app-resume-manager-new-ar',
  templateUrl: './resume-manager-new-ar.component.html',
  styleUrls: ['./resume-manager-new-ar.component.css']
})
export class ResumeManagerNewArComponent implements OnInit {
