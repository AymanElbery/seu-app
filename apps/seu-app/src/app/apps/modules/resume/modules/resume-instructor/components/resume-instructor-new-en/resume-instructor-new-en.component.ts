...
@Component({
  selector: 'app-resume-instructor-new-en',
  templateUrl: './resume-instructor-new-en.component.html',
  styleUrls: ['./resume-instructor-new-en.component.css']
})
export class ResumeInstructorNewEnComponent implements OnInit {
