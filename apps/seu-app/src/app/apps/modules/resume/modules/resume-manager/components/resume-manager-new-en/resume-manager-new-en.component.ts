...
@Component({
  selector: 'app-resume-manager-new-en',
  templateUrl: './resume-manager-new-en.component.html',
  styleUrls: ['./resume-manager-new-en.component.css']
})
export class ResumeManagerNewEnComponent implements OnInit {
