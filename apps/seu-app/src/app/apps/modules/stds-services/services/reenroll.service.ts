...
export class ReenrollService extends StudentService {
    ...
    getRequests(){
        return this.get('/stds/reenroll/requests');
    }

    deleteReq(req_pk){
        return this.get('/stds/reenroll/remove/' + req_pk);
    }  

    AddRequest(data){
        return this.post('/stds/reenroll/add', data);
    }   
}
