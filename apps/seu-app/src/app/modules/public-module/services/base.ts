...
export class PublicBaseService {
    URL = environment.baselink + environment.servicesprefix;
    ...
    constructor(private http: HttpClient,private router: Router,private globalService: GlobalBaseService,private translate: TranslateService,private toaster: AppToasterService) {
