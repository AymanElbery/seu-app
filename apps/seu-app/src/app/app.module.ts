...
@NgModule({
  declarations: [
    AppComponent,HomeComponent,HeaderComponent, AutoGeneratedComponent, NameComponentComponent
  ],
  imports: [
    BrowserModule,HttpClientModule,
    AppRoutingModule,AccountModule,DashboardModule,FormsModule,AcademicprocsModule,AcademicaffModule,RegisterCoursesModule,EqualizeModule
    ,LecturesAbsenceModule,FinanceAffairModule,ExamsAffairModule,OtherAffairModule
  ],
