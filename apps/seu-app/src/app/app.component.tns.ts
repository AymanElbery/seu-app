        ...
        this.Employee_Menu = [
            {
                ...
                subTitles: [
                    {
                        subTitle: ' بياناتي الوظيفية',
                        route: '/personal/'
                    },
                    {
                        subTitle: 'طباعة  شهادة التعاريف',
            ...
            },
            {
                ...
                subTitles: [
                    {
                        subTitle: 'استعلام عن الاجازات',
                        route: '/personal/vacations'
                    },
                    {
                        subTitle: 'استعلام عن الحسم من الاجازات',
                        route: '/administrative/penalty-discount'
                    },
                    {
                        subTitle: ' استعلام عن العهد',
                        route: '/administrative/emp-custody'
                    },
                    {
                        subTitle: ' استعلام عن التقويم',
            ...
            },
            {
                ...
                subTitles: [
                    {
                        subTitle: ' طلب اجازه ',
                        route: '/requests/vacation-request/1'
                    },
                    {
                        subTitle: ' طلب ايام الاجازة المتفرقه ',
                        route: '/requests/vacation-request/6'
                    },
                    {
                        subTitle: ' طلب حسم من الاجازة ',
                        route: '/requests/regular-leave-request/37'
                    },
                    {
                        subTitle: ' طلب اخلاء طرف ',
                        route: '/requests/evacuate-party-request/65'
                    },
                    {
                        subTitle: 'متابعة طلباتي ',
                        route: '/requests/requests-list'
                    },
                    {
                        subTitle: 'طلبات في انتظار موافقتي ',
